...
* **Event Related Potentials [ERPs]**
  ...
  12. [ERP CORE] (https://erpinfo.org/erp-core) : The ERP CORE is a freely available online resource consisting of optimized paradigms, experiment control scripts, example data from 40 participants, data processing pipelines and analysis scripts, and a broad set of results for 7 different ERP components obtained from 6 different ERP paradigms. [[Article]] (https://doi.org/10.1016/j.neuroimage.2020.117465)
...
### Others [Unfiltered]
  ...
  15. ERP Core Dataset https://erpinfo.org/erp-core
